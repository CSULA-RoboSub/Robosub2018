...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.currentChanged['int'].connect(self.start_tasks.click)
        self.tabWidget.currentChanged['int'].connect(self.forward.click)
        self.auto_checkbox.stateChanged['int'].connect(self.start_tasks.animateClick)
        self.power.valueChanged['int'].connect(self.messages.paste)
